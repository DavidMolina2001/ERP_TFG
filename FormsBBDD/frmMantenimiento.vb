...
#Region "Atributs"
    ...
    Public oDades As clsMantenimiento
...
#Region "Constructor"
    ...
    Public Sub New(_oConn As SqlConnection, _Id As Integer, _IdFurgoneta As Integer)
        ...
        Me.oConn = _oConn
        oDades = New clsMantenimiento
        oDades.IdFurgoneta = _IdFurgoneta
        tbiFurgoneta.Enabled = False
        iId = _Id
...
#Region "Metodes"
    ...
    Private Sub CopiarControlsADades()
        oDades.IdFurgoneta = tbiFurgoneta._Valor
        oDades.FechaMantenimiento = dtpManteniment.Value
        oDades.Observaciones = tbxObservacions.Text
    End Sub

    Private Sub CopiarDadesAControls()
        tbiFurgoneta._Valor = oDades.IdFurgoneta
        dtpManteniment.Value = oDades.FechaMantenimiento
        tbxObservacions.Text = oDades.Observaciones
    End Sub

    Private Sub Inicialitzacions()

        tbiFurgoneta.uObjRecord = New clsFurgonetas

        If oDades.IdFurgoneta <> 0 Then
            tbiFurgoneta._Valor = oDades.IdFurgoneta
        End If
    End Sub
