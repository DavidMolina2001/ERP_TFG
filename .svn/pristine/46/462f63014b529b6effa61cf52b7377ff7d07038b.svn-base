...
#Region "Atributs"
    ...
    Private oDades As clsTrabajadores
...
#Region "Metodes"
    ...
    Private Sub CopiarControlsADades()
        ...
        oDades.Apellidos = tbxApellidos.Text
        oDades.DNI = tbxDNI.Text
        oDades.Mail = tbxMail.Text
    End Sub

    Private Sub CopiarDadesAControls()
        tbxNom.Text = oDades.Nombre
        tbxApellidos.Text = oDades.Apellidos
        tbxDNI.Text = oDades.DNI
        tbxMail.Text = oDades.Mail
    End Sub

    Private Sub Inicialitzacions()
        Me.Text = fnTraductor.RetornaIdiomaSeleccionat("Trabajadores", "Treballadors")
    End Sub
