...
Public Class frmEnvios_Historicos

#Region "Atributs"

    Public oDades As clsEnvios_Historico
...
#Region "Constructor"
    Public Sub New(_oConn As SqlConnection, _Id As Integer, _IdEnvio As Integer)
        ...
        Me.oConn = _oConn
        oDades = New clsEnvios_Historico
        oDades.IdEnvio = _IdEnvio
        iId = _Id
...
#Region "Metodes"
    ...
    Public Function TryLoad() As Boolean
        ...
        Try
            ...
            Me.Text = fnTraductor.RetornaIdiomaSeleccionat("Histórico", "Històric")
    ...
    Private Sub CopiarControlsADades()
        oDades.FechaEstado = DateTimePicker1.Value
        oDades.Estado = cmbxEstat.SelectedIndex
