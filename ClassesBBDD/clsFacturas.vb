...
#Region "Consultas"
    ...
    Public Overrides Function NomCampMostrar(nombreAtributo As String) As String
        ...
        Select Case nombreAtributo
            ...
            Case "NumFactura"
                nombreColumna = fnTraductor.RetornaIdiomaSeleccionat("Número de Factura", "Número de Factura")
            Case "IdClient"
                nombreColumna = fnTraductor.RetornaIdiomaSeleccionat("ID Cliente", "ID Client")
            Case "NomClient"
                nombreColumna = fnTraductor.RetornaIdiomaSeleccionat("Nombre Cliente", "Nom Client")
            Case "Cobrado"
                nombreColumna = fnTraductor.RetornaIdiomaSeleccionat("Cobrado", "Cobrat")
            Case "FechaEmision"
                nombreColumna = fnTraductor.RetornaIdiomaSeleccionat("Fecha de Emisión", "Data d'Emisió")
            Case "FechaVencimiento"
                nombreColumna = fnTraductor.RetornaIdiomaSeleccionat("Fecha de Vencimiento", "Data de Venciment")
            Case "Observaciones"
                nombreColumna = fnTraductor.RetornaIdiomaSeleccionat("Observaciones", "Observacions")
            Case "TotalBruto"
                nombreColumna = fnTraductor.RetornaIdiomaSeleccionat("Total sin Impuestos", "Total Sense Impostos")
            Case "TotalLimpio"
                nombreColumna = fnTraductor.RetornaIdiomaSeleccionat("Total con Impuestos", "Total amb Impostos")
            Case Else
